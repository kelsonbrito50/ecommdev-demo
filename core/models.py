...
class Depoimento(models.Model):
    ...
    avaliacao = models.PositiveSmallIntegerField(_('Avaliação'), choices=[(i, str(i)) for i in range(1, 6)], default=5)
...
class FAQ(models.Model):
    ...
    categoria = models.CharField(_('Categoria'), max_length=20, choices=CATEGORIA_CHOICES, default='geral')
