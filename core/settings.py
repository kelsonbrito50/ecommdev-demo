"""
Django settings for ecommdev project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='ecommdev'),
        'USER': config('DB_USER', default='ecommdev'),
        'PASSWORD': config('DB_PASSWORD', default='ecommdev_password'),
