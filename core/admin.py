...
from .models import FAQ, ConfiguracaoSite, Contato, Depoimento
...
class ConfiguracaoSiteAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identificação", {"fields": ("nome_site_pt", "nome_site_en", "tagline_pt", "tagline_en")}),
        ("Descrição", {"fields": ("descricao_pt", "descricao_en")}),
        ("Imagens", {"fields": ("logo", "favicon")}),
        (
            "Contato",
            {
                "fields": (
        ...
        ("Redes Sociais", {"fields": ("linkedin", "instagram", "github", "youtube")}),
        ("SEO", {"fields": ("meta_keywords", "meta_description_pt", "meta_description_en")}),
