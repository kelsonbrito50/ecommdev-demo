...
from core.models import FAQ, ConfiguracaoSite
...
class Command(BaseCommand):
    ...
    def seed_packages(self):
        ...
        packages_data = [
            {
                ...
                "recursos": [
                    (
                        "Entrega do sistema conforme desenvolvido",
                        "System delivery as developed",
                        True,
                    ),
            ...
            },
            {
                ...
                "recursos": [
                    ...
                    (
                        "Integração com Mercado Pago ou PagSeguro",
                        "Mercado Pago or PagSeguro integration",
                        True,
                    ),
            ...
            },
            {
                ...
                "recursos": [
                    ...
                    (
                        "Customizações adicionais (até 20h)",
                        "Additional customizations (up to 20h)",
                        True,
                    ),
                ],
            },
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Created {len(packages_data)} packages with resources")
        )
