...
class Command(BaseCommand):
    ...
    def _update_servicos(self):
        ...
        apartir_updates = [
            {'keyword': 'institucional', 'preco': Decimal('2500.00'), 'label': 'Sites Institucionais'},
            ...
            {'keyword': 'personalizado', 'preco': Decimal('8000.00'), 'label': 'Sistemas Web Personalizados'},
        ]
        ...
        for item in apartir_updates:
            ...
            if count:
                ...
                self.stdout.write(
                    self.style.WARNING(f"  ⚠ [{item['label']}] — nenhum registro encontrado (keyword: '{item['keyword']}')")
                )
    ...
    def _update_pacotes(self):
        ...
        pacote_updates = [
            {'keywords': ['básico', 'basico'], 'preco': Decimal('2000.00'), 'label': 'Pacote Básico'},
