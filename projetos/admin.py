...
from .models import ArquivoProjeto, MensagemProjeto, Milestone, Projeto, TimelineEvento
...
class ProjetoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Financeiro"), {"fields": ("valor_total", "observacoes"), "classes": ["collapse"]}),
    ...
    def cliente_link(self, obj):
        ...
        if obj.cliente:
            ...
            return format_html(
                '<a href="{}">{}</a>', url, obj.cliente.nome_completo or obj.cliente.email
            )
        return "-"
    ...
    def progresso_bar(self, obj):
        """Show progress bar."""
        color = (
            "#28a745" if obj.progresso >= 75 else "#ffc107" if obj.progresso >= 50 else "#17a2b8"
        )
        return format_html(
...
class MilestoneAdmin(admin.ModelAdmin):
    ...
    def atrasado(self, obj):
        ...
        if (
            ...
            and obj.data_previsao
            and obj.data_previsao < timezone.now().date()
        ):
