...
class Projeto(models.Model):
    ...
    pacote = models.ForeignKey(
        "pacotes.Pacote", on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("Pacote")
    )
    ...
    status = models.CharField(
        _("Status"), max_length=20, choices=STATUS_CHOICES, default="aprovado"
    )
...
class Milestone(models.Model):
    ...
    projeto = models.ForeignKey(
        Projeto, on_delete=models.CASCADE, related_name="milestones", verbose_name=_("Projeto")
    )
...
class TimelineEvento(models.Model):
    ...
    projeto = models.ForeignKey(
        Projeto, on_delete=models.CASCADE, related_name="timeline", verbose_name=_("Projeto")
    )
...
class MensagemProjeto(models.Model):
    ...
    projeto = models.ForeignKey(
        Projeto, on_delete=models.CASCADE, related_name="mensagens", verbose_name=_("Projeto")
    )
    autor = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, verbose_name=_("Autor")
    )
...
class ArquivoProjeto(models.Model):
    ...
    projeto = models.ForeignKey(
        Projeto, on_delete=models.CASCADE, related_name="arquivos", verbose_name=_("Projeto")
    )
    ...
    arquivo = models.FileField(
        _("Arquivo"), upload_to="projetos/arquivos/", validators=[validate_document]
    )
    descricao = models.TextField(_("Descrição"), blank=True)
