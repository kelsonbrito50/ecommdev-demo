...
from clientes.models import PerfilEmpresa, LogLogin, SessaoAtiva
...
class UsuarioModelTest(TestCase):
    ...
    def test_username_field_not_present(self):
        self.assertFalse(hasattr(self.user, 'username') and User._meta.get_field('email').name == 'email')
...
class SessaoAtivaModelTest(TestCase):
    ...
    def test_multiple_sessions_for_same_user(self):
        sessao2 = SessaoAtiva.objects.create(
            usuario=self.user,
