...
urlpatterns = [
    ...
    # Email verification
    path(
        "verificar-email/<uuid:token>/", views.VerificarEmailView.as_view(), name="verificar_email"
    ),
    path(
        "verificar-email/enviado/",
        views.VerificarEmailEnviadoView.as_view(),
        name="verificar_email_enviado",
    ),
    path(
        "verificar-email/reenviar/",
        views.ReenviarVerificacaoView.as_view(),
        name="reenviar_verificacao",
    ),
    # Password reset
    path(
        "senha/reset/",
        auth_views.PasswordResetView.as_view(template_name="clientes/password_reset.html"),
        name="password_reset",
    ),
    path(
        "senha/reset/enviado/",
    ...
    path(
        "perfil/sessoes/<int:pk>/encerrar/",
        views.EncerrarSessaoView.as_view(),
