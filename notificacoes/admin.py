...
from .models import Notificacao, LogEmail, ConfiguracaoNotificacao
...
class LogEmailAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['destinatario', 'tipo', 'assunto', 'conteudo', 'status', 'erro', 'tentativas', 'enviado_at', 'created_at']
    ordering = ['-created_at']
    date_hierarchy = 'created_at'
...
class ConfiguracaoNotificacaoAdmin(admin.ModelAdmin):
    list_display = ['usuario', 'email_atualizacao_projeto', 'email_nova_fatura', 'email_resposta_ticket', 'email_newsletter']
    ...
    fieldsets = (
        ...
        ('Notificacoes por Email', {
            'fields': ('email_atualizacao_projeto', 'email_nova_fatura', 'email_resposta_ticket', 'email_newsletter', 'email_marketing')
        }),
        ('Notificacoes Push', {
