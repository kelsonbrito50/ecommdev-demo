...
cat_ecommerce, _ = CategoriaPortfolio.objects.get_or_create(
    slug='e-commerce',
    defaults={'nome_pt': 'E-commerce', 'nome_en': 'E-commerce', 'ordem': 1}
)
cat_sistema, _ = CategoriaPortfolio.objects.get_or_create(
    slug='sistemas',
    defaults={'nome_pt': 'Sistemas', 'nome_en': 'Systems', 'ordem': 2}
)
...
cat_landing, _ = CategoriaPortfolio.objects.get_or_create(
    slug='landing-page',
    defaults={'nome_pt': 'Landing Page', 'nome_en': 'Landing Page', 'ordem': 4}
)
cat_dashboard, _ = CategoriaPortfolio.objects.get_or_create(
    slug='dashboard',
    defaults={'nome_pt': 'Dashboard', 'nome_en': 'Dashboard', 'ordem': 5}
)
