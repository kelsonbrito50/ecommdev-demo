...
class Fatura(models.Model):
    ...
    desconto = models.DecimalField(_('Desconto'), max_digits=10, decimal_places=2, default=Decimal('0.00'))
    impostos = models.DecimalField(_('Impostos'), max_digits=10, decimal_places=2, default=Decimal('0.00'))
    valor_total = models.DecimalField(_('Valor Total'), max_digits=10, decimal_places=2, default=Decimal('0.00'))
