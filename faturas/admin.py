...
class FaturaAdmin(admin.ModelAdmin):
    list_display = ['numero', 'cliente', 'projeto', 'valor_display', 'status_badge', 'data_vencimento', 'data_pagamento']
    ...
    fieldsets = (
        ...
        ('Valores', {
            'fields': ('subtotal', 'desconto', 'impostos', 'valor_total')
        }),
        ('Datas', {
...
class PagamentoAdmin(admin.ModelAdmin):
    list_display = ['fatura', 'metodo', 'valor_display', 'status_badge', 'gateway', 'data_pagamento']
